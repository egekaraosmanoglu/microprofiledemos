...
This will create an executable jar file **wildfly33-wildfly.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/wildfly33-wildfly.jar -Djboss.socket.binding.port-offset=100
